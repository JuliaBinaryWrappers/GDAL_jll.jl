...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/dc21615fc5a334f9821f49339032067676b55035/G/GDAL/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://github.com/OSGeo/gdal/releases/download/v3.5.2/gdal-3.5.2.tar.gz (SHA256 checksum: `fbd696e1b2a858fbd2eb3718db16b14ed9ba82521d3578770d480c74fe1146d2`)
