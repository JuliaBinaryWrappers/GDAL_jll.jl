...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/82e82aabebd7a9ebd235b5f2cfea82eaac3a1403/G/GDAL/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* compressed archive: https://github.com/OSGeo/gdal/releases/download/v3.6.2/gdal-3.6.2.tar.gz (SHA256 checksum: `cd5bf004af85b88414676b0d5694d3192414e556961ee3d47164f3298078a818`)
