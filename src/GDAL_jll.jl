...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import GDAL_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("a7073274-a066-55f0-b90d-d619367d196c"))
platforms = [Pkg.Artifacts.unpack_platform(e, "GDAL", artifacts_toml) for e in artifacts["GDAL"]]
...
if best_platform === nothing
    @debug("Unable to load GDAL; unsupported platform $(triplet(platform_key_abi()))")
else
