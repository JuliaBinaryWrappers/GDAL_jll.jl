...
JLLWrappers.@declare_library_product(libgdal, "@rpath/libgdal.38.dylib")
...
function __init__()
    JLLWrappers.@generate_init_header(Arrow_jll, Blosc_jll, Expat_jll, GEOS_jll, HDF4_jll, HDF5_jll, LERC_jll, LibCURL_jll, LibPQ_jll, Libtiff_jll, Lz4_jll, NetCDF_jll, OpenJpeg_jll, PCRE2_jll, PROJ_jll, Qhull_jll, SQLite_jll, XML2_jll, XZ_jll, Zlib_jll, Zstd_jll, libgeotiff_jll, libpng_jll, libwebp_jll, muparser_jll, MPItrampoline_jll, MPIPreferences)
    JLLWrappers.@init_library_product(
        libgdal,
        "lib/libgdal.38.dylib",
