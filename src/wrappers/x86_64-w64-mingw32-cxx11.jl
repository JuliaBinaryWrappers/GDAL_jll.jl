...
export ogrlineref_path, gdalinfo_path, gdaltransform_path, gdaladdo_path, gdallocationinfo_path, gdal_grid_path, gdal_rasterize_path, gdaltindex_path, ogrinfo_path, gdal_contour_path, gdalmanage_path, ogr2ogr_path, gdalsrsinfo_path, ogrtindex_path, gdalwarp_path, gdalbuildvrt_path, gdal_translate_path, gdaldem_path, libgdal, nearblack_path
