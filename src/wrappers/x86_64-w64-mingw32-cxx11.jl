# Autogenerated wrapper script for GDAL_jll for x86_64-w64-mingw32-cxx11
export gdalmanage_path, gdal_rasterize_path, gdaltindex_path, gdal_translate_path, gdallocationinfo_path, gdalsrsinfo_path, ogr2ogr_path, ogrinfo_path, ogrlineref_path, gdalinfo_path, gdalwarp_path, gdal_contour_path, ogrtindex_path, gdaltransform_path, libgdal, gdaldem_path, gdalbuildvrt_path, gdal_grid_path, nearblack_path, gdaladdo_path
...
const gdalmanage_path_splitpath = ["bin", "gdalmanage.exe"]
...
const gdal_rasterize_path_splitpath = ["bin", "gdal_rasterize.exe"]
...
const gdaltindex_path_splitpath = ["bin", "gdaltindex.exe"]
...
const gdal_translate_path_splitpath = ["bin", "gdal_translate.exe"]
...
const gdallocationinfo_path_splitpath = ["bin", "gdallocationinfo.exe"]
...
const gdalsrsinfo_path_splitpath = ["bin", "gdalsrsinfo.exe"]
...
const ogr2ogr_path_splitpath = ["bin", "ogr2ogr.exe"]
...
const ogrinfo_path_splitpath = ["bin", "ogrinfo.exe"]
...
const ogrlineref_path_splitpath = ["bin", "ogrlineref.exe"]
...
const gdalinfo_path_splitpath = ["bin", "gdalinfo.exe"]
...
const gdalwarp_path_splitpath = ["bin", "gdalwarp.exe"]
...
const gdal_contour_path_splitpath = ["bin", "gdal_contour.exe"]
...
const ogrtindex_path_splitpath = ["bin", "ogrtindex.exe"]
...
const gdaltransform_path_splitpath = ["bin", "gdaltransform.exe"]
...
const libgdal_splitpath = ["bin", "libgdal-26.dll"]
...
const libgdal = "libgdal-26.dll"


# Relative path to `gdaldem_path`
const gdaldem_path_splitpath = ["bin", "gdaldem.exe"]
...
const gdalbuildvrt_path_splitpath = ["bin", "gdalbuildvrt.exe"]
...
const gdal_grid_path_splitpath = ["bin", "gdal_grid.exe"]
...
const nearblack_path_splitpath = ["bin", "nearblack.exe"]
...
const gdaladdo_path_splitpath = ["bin", "gdaladdo.exe"]
